...
public class Orcrist implements IWeapon {
    ...
    public String getWeaponDescription() {
        return  "Made by the Elves of Gondolin, Orcrist was forged along with its sister blade, Glamdring. Like Glamdring and Sting, it would glow blue whenever enemies were near." +
