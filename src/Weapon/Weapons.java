...
public class Weapons {
    ...
    public  String getWeaponDescription(String name) {
        ...
        switch (name) {
            ...
            case "Eldond Ring" -> tempWeaponDesc = "Vilya was the strongest of the three Elven rings. Its exact powers are unknown, but it is believed that it gave its bearer healing powers and control over minor elements, such as water. Elrond’s ability to summon a torrent of water to chase off the Ringwraiths is thought to be in part powered by Vilya.  \n" +
                    "\nHistory: Just before the death of Gil-galad, the High King of the Ñoldor in Middle-Earth, the ring was given to Elrond.";
            case "Gandalf Staff" -> tempWeaponDesc = "Gandalf had two staffs. The first was made of gnarled wood and cradled a jewel at the top that would light up. His second staff was white with a slightly more geometric design.\n" +
